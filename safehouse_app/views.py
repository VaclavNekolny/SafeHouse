...
from safehouse_app.models import Klienti, Produkty, Smlouvy, Historie
from django.db.models import Sum
import random


def index(request):
    return render(request, "safehouse_app/index.html")


def produkty(request):
    produkty = Produkty.objects.all()
    return render(request, 'safehouse_app/produkty.html', {'produkty': produkty})
...
def produkt_pridat(request):
    if request.method == "POST":
        ...
        return render(request, 'safehouse_app/produkt_pridat.html', {'message': message, 'pridat': True})

    return render(request, 'safehouse_app/produkt_pridat.html', {'pridat': True})
...
def produkt_editovat(request, edit_id):
    ...
    if request.method == "POST":
        ...
        return render(request, 'safehouse_app/produkt_editovat.html', {'message': message, 'editovat': True})

    produkt_k_editaci = Produkty.objects.get(id=edit_id)
    return render(request, 'safehouse_app/produkt_editovat.html', {'editovat': True, 'produkt': produkt_k_editaci})
...
def klienti(request):
    ...
    return render(request, 'safehouse_app/klienti.html', {'klienti': vsichni_klienti})
...
def klient_detail(request, id_klienta):
    ...
    return render(request, 'safehouse_app/klient_smlouvy.html', {'klient': klient, 'smlouvy': smlouvy_klienta, 'celkem_mesicne': celkem_mesicne})
...
def klient_pridat(request):
    if request.method == "POST":
        ...
        return render(request, 'safehouse_app/klient_pridat.html', {'message': message, 'pridat': True})

    return render(request, 'safehouse_app/klient_pridat.html', {'pridat': True})
...
def klient_vymazat(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'safehouse_app/klient_vymazat.html', {'message': message, 'vymazat': True, 'klienti': klienti})

    return render(request, 'safehouse_app/klient_vymazat.html', {'vymazat': True, 'klienti': klienti})
...
def klient_editovat(request, klient_id):
    ...
    if request.method == "POST":
        ...
        return render(request, 'safehouse_app/klient_editovat.html', {'message': message, 'editovat': True})

    klient_k_editaci = Klienti.objects.get(id=klient_id)
    return render(request, 'safehouse_app/klient_editovat.html', {'editovat': True, 'klient': klient_k_editaci})
...
def smlouvy(request):
    ...
    return render(request, 'safehouse_app/smlouvy.html', {'smlouvy': smlouvy,
...
def smlouva_nova(request, klient_id):
    ...
    if request.method == "POST":
        ...
        return render(request, 'safehouse_app/produkt_vybrany.html', {'produkt': produkt, 'klient': klient})

    produkty = Produkty.objects.all()
    return render(request, 'safehouse_app/smlouva_nova.html', {'produkty': produkty,
                                                               'klient': klient})
...
def historie(request):
    ...
    return render(request, 'safehouse_app/historie.html', {'historie': historie})


def nedostupne(request):
    return render(request, 'safehouse_app/nedostupne.html')
